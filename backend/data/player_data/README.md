# EAGLE GAME - Player Event Data

## What is this?

This dataset contains **5 days of production gameplay data** (Feb 10-14, 2026) from **EAGLE GAME**, a battle-royale style game. Each file records one player's journey through one match.
...
**EAGLE GAME** is an extraction shooter where:
